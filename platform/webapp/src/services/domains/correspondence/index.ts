 ...
 *
 * Barrel export for correspondence service, types, hooks, and view models.
 *
 * Architecture Rules:
 * - API types: re-exports from @forgetcase/core only
...
// ============================================================================
export { correspondenceFacade } from './facade';
