/**
 * Correspondence API Types
 *
 * API contract types come from @forgetcase/core.
 * This file contains ONLY re-exports - no local API contract definitions.
 */

// ============================================================================
// API Type Re-exports (from @forgetcase/core)
// ============================================================================
...
export type {
  // Add types from @forgetcase/core/correspondence
} from "@forgetcase/core";

// Re-export with alias for backward compatibility if needed
// export type CoreCorrespondenceItem = CorrespondenceItem;
