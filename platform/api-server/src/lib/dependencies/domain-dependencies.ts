...
const DOMAIN_PATH_PATTERNS: Array<{ pattern: RegExp; domain: string }> = [
  ...
  { pattern: /\/correspondence\//, domain: "correspondence" },
  { pattern: /\/fulfilment\//, domain: "fulfilment" },
  { pattern: /\/identity\//, domain: "identity" },
  { pattern: /\/sla\//, domain: "sla" },
];
  ...
  if (!domainDeps) {
    ...
    switch (domain) {
      ...
      case "cases":
        ...
        break;
      case "correspondence":
        domainDeps = buildCorrespondenceDomainModule(dynamoClient);
        break;
      case "fulfilment":
        domainDeps = buildFulfilmentDomainModule(dynamoClient);
        break;
      case "identity":
        domainDeps = buildIdentityDomainModule(dynamoClient);
        break;
      case "sla":
        domainDeps = buildSlaDomainModule(dynamoClient);
        break;
      default:
        return;
    }
...
export interface DomainDependencies {
  ...
  correspondence: CorrespondenceDomainModule;
  fulfilment: FulfilmentDomainModule;
...
export function getCorrespondenceDeps(
  request: FastifyRequest,
): DomainDependencies["correspondence"] {
  return getDomainDeps(request, "correspondence");
}
export function getFulfilmentDeps(
  request: FastifyRequest,
): DomainDependencies["fulfilment"] {
  return getDomainDeps(request, "fulfilment");
}
...
export function getSlaDeps(
  request: FastifyRequest,
): DomainDependencies["sla"] {
  return getDomainDeps(request, "sla");
}
